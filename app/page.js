...
const page = () => {
  ...
  <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6 ">
      <div className="mx-auto max-w-screen-sm text-center mb-8 lg:mb-16">
          <h2 className="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">Lorem Picsum Api </h2>
          <p className="font-light text-gray-500 lg:mb-16 sm:text-xl dark:text-gray-400">Fetching Lorem Picsum Api and Generating random numbers using Axios in Next Js Project</p>
      </div> 
      <div className="grid gap-8 mb-6 lg:mb-16 md:grid-cols-2">
        {Images.map((e,i)=>{
             return<div className="items-center bg-gray-50 rounded-lg shadow sm:flex dark:bg-gray-800 dark:border-gray-700">
              <a href="#">
                  <Image className="w-full rounded-lg sm:rounded-none sm:rounded-l-lg" key={i} width={400} height={400} src={e.download_url} alt="Bonnie Avatar"/>
              </a>
              <div className="p-5">
                  <h3 className="text-xl font-bold tracking-tight text-gray-900 dark:text-white">
                      <a href="#">Talha Sharif</a>
                  </h3>
                  <span className="text-gray-500 dark:text-gray-400" >Web Developer {random} </span>
...
<footer className="bg-white rounded-lg shadow m-5 dark:bg-gray-800">
    <div className="w-full mx-auto  max-w-screen-xl p-4 md:flex md:items-center md:justify-between text-center">
      <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 Talha™. All Rights Reserved.
    </span>
